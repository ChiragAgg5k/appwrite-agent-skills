...
![License](https://img.shields.io/github/license/ChiragAgg5k/appwrite-agent-skills.svg?style=flat-square)
...
**This SDK is compatible with Appwrite server version 1.8.x. For older versions, please check [previous releases](https://github.com/ChiragAgg5k/appwrite-agent-skills.git/releases).**
